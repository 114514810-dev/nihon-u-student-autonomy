      ...
      <main className="flex-1 max-w-4xl mx-auto px-4 py-12 w-full">
        ...
        <section className="mb-12">
          ...
          <Card className="bg-orange-50 border-orange-200">
            ...
            <CardContent className="text-slate-700 space-y-4">
              <p>
                第三者委員会は、以下の点が重なって不正が連鎖したと整理しています。
              </p>
              <ul className="space-y-2">
                <li>✗ 理事長が理事会・監査役会を掌握し、内部監査は2名体制で事業部を監査できなかった</li>
                <li>✗ 株式会社日本大学事業部が年1回の形式的な取締役会しか開かず、社外役員ゼロ</li>
                <li>✗ 監査役の意見書は理事長室で止まり、理事会や評議員会には「問題なし」とだけ共有</li>
                <li>✗ 通報窓口が理事長側に一元化され、職員が不正を指摘すると人事で報復されるとの恐怖があった</li>
                <li>✗ 学生・教職員が意思決定に参加する場がなく、重大事案を事前に知る手段がなかった</li>
              </ul>
              <p className="font-semibold text-red-900 mt-4">
                結果：板橋病院建替え・医療機器調達などで約5億円規模の損害が発生
              </p>
            </CardContent>
          </Card>
        </section>
